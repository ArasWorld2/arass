...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Build the Wizz Air Embed Layout
        const inviteEmbed = new EmbedBuilder()
            ...
            .addFields({
                name: '<:click:1414277937187782818> [Academy Invitation](https://discord.gg/GZPHEGTBEA)',
                value: '> This link is strictly protected under our internal regulations, and leaking to third-parties will result in a **blacklist** from our organisation. Ensure that you follow the instructions provided to verify and continue your journey within the academy.'
            })
            .setFooter({
        ...
        // Loop through each user ID and attempt to DM them the embed
        for (const id of userIds) {
            try {
                const user = await interaction.client.users.fetch(id);
                
                // Send only the embed (Viszlát text removed)
