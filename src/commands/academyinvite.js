...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // 3. Build the Academy Invitation Embed
        const inviteEmbed = new EmbedBuilder()
            .setTitle('✈️ Air Dolomiti — Academy Invitation')
            .setDescription(
                `Hello!\n\nYou have been officially invited to join the **Air Dolomiti Academy**.\n` +
                `Please follow the instructions provided by the staff or click below to proceed with your training.`
            )
            .setColor('#0072B2')
            .setTimestamp();

        // 4. Loop through each user ID and attempt to DM them
